...
for (i = 0; i<list.length; i++) {
	...
	save_folder_name = "/Users/fanhong/Documents/Harvard_Postdoc/2.OnGoingProject/ThermoPlexImaging/10.Manuscript_preparation/"+data_folder+Temperature;
