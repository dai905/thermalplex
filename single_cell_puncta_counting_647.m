...
boxsize = 4;
bg_filter = 20;
intensity_filter = 70; % set the intensity parameter to identify the spot
...
if ~isempty(puncta_location)
    showSpot(puncta_location(:,1:2),boxsize);
    writematrix(puncta_location,sprintf('single_cell_RNA_counts/%s_15_RNA_%s_647.txt',cell_name,Temperature))
